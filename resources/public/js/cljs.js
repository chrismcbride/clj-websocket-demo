...
;function Sb() {
  var a = Tb.call(h);
  return Ub.call(h, a, function() {
    Vb.call(h, a, function(a) {
      return Rb.call(h, a.data)
    });
    return a.send("hello")
  })
}
var Wb = "alephtest.websocket.init".split("."), $ = this;
!(Wb[0] in $) && $.execScript && $.execScript("var " + Wb[0]);
for(var Xb;Wb.length && (Xb = Wb.shift());) {
  !Wb.length && s(Sb) ? $[Xb] = Sb : $ = $[Xb] ? $[Xb] : $[Xb] = {}
}
function Tb() {
